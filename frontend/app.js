...
async function startNumberGuess() {
    await startGame("/guess/start", "guess");
}

async function startBullsCows() {
    await startGame("/bulls-cows/start", "bulls_cows");
}

async function startGame(endpoint, type) {
    ...
    document.getElementById("gameHint").innerText = "Game started!";
}
